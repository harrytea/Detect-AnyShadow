...
from dataloaders.eval_datasets import VSDTest
from dataloaders.eval_visha import ViSha_Test
...
class EvaluatorVisha(object):
    ...
    def prepare_dataset(self):
        ...
        self.dataset = ViSha_Test(root=cfg.TEST_DATASET_PATH, transform=eval_transforms, result_root=self.result_root)
